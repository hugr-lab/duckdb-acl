 ...
 */
/* LOCAL PATCH (duckdb-acl): exclude AArch64 - the asm below uses 32-bit Arm/Thumb register
 * constraints; on 64-bit cores the C fallback compiles to a constant-time MUL anyway. */
